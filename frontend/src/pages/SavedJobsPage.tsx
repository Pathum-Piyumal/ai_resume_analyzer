...
export default function SavedJobsPage() {
  ...
  const handleUnsave = (id: number) => {
    const jobToMove = savedJobs.find(j => j.id === id)
    if (jobToMove) {
      setExploreJobs(prev => [...prev, { ...jobToMove }])
    }
  ...
  const filteredJobs = savedJobs.filter(job => {
    ...
    const matchesLocation = 
      ...
      (activeFilter === 'onsite' && job.location.toLowerCase() !== 'remote')
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col flex-grow">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-4">
                      ...
                      <a href="#" className="flex items-center gap-1 text-[11px] font-bold text-white hover:text-brand-lightBlue transition-colors group focus:outline-none">
